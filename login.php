...
<p ><h4><u>Welcome back!</u></h4></p></center>
 ...
 <input type = "email" class="fcontrol" placeholder = "Registered e-mail" name = "value" required> <br><br>
 

 <label><br><b> Password:<font color="#ff2600"><sup>*</sup></font></b></label>
 <input type = "password" class="fcontrol" placeholder = "Enter strong password" name = "pass" required> <br><br>
